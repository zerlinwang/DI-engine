...
main_config_10m11m = EasyDict(main_config_10m11m)
create_config_10m11m = dict(
    env=dict(
        type='smac',
...
create_config_10m11m = EasyDict(create_config_10m11m)


main_config_5m6m = dict(
...
main_config_5m6m = EasyDict(main_config_5m6m)
create_config_5m6m = dict(
    env=dict(
        type='smac',
        import_names=['dizoo.smac.envs.smac_env'],
    ),
...
create_config_5m6m = EasyDict(create_config_5m6m)


main_config_8m9m = dict(
...
main_config_8m9m = EasyDict(main_config_8m9m)
create_config_8m9m = dict(
    env=dict(
        type='smac',
        import_names=['dizoo.smac.envs.smac_env'],
    ),
...
create_config_8m9m = EasyDict(create_config_8m9m)


if __name__ == '__main__':

    from ding.entry import serial_pipeline_marine_onpolicy
    serial_pipeline_marine_onpolicy((main_config_5m6m, create_config_5m6m), (main_config_8m9m, create_config_8m9m), (main_config_10m11m, create_config_10m11m), seed=0)
