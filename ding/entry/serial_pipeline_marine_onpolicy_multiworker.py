...
def serial_pipeline_marine_onpolicy_multiworker(
    ...
    cfg_1011.exp_name = 'marine_multiworker_10m11m_mappo_seed0'
    cfg_1011.env.map_name = '10m_vs_11m'
    cfg_89, create_cfg_89 = deepcopy(input_cfg)
    cfg_89.exp_name = 'marine_multiworker_8m9m_mappo_seed0'
    cfg_89.env.map_name = '8m_vs_9m'
    cfg_56, create_cfg_56 = deepcopy(input_cfg)
    cfg_56.exp_name = 'marine_multiworker_5m6m_mappo_seed0'
...
def serial_pipeline_marine_onpolicy_singlelearner(
        input_cfg: Union[str, Tuple[dict, dict]],
        seed: int = 0,
        env_setting: Optional[List[Any]] = None,
        model: Optional[torch.nn.Module] = None,
    ...
    #     cfg, create_cfg = deepcopy(input_cfg)
    cfg_1011, create_cfg_1011 = deepcopy(input_cfg)
    cfg_1011.exp_name = 'marine_singlelearner_10m11m_mappo_seed0'
    cfg_1011.env.map_name = '10m_vs_11m'
    cfg_89, create_cfg_89 = deepcopy(input_cfg)
    cfg_89.exp_name = 'marine_singlelearner_8m9m_mappo_seed0'
    cfg_89.env.map_name = '8m_vs_9m'
    cfg_56, create_cfg_56 = deepcopy(input_cfg)
    cfg_56.exp_name = 'marine_singlelearner_5m6m_mappo_seed0'
    cfg_56.env.map_name = '5m_vs_6m'
    create_cfg_1011.policy.type = create_cfg_1011.policy.type + '_command'
    create_cfg_89.policy.type = create_cfg_89.policy.type + '_command'
    create_cfg_56.policy.type = create_cfg_56.policy.type + '_command'
    ...
    while True:
        ...
        if stop_1011 and stop_89 and stop_56:
            break
        # Collect data by default config n_sample/n_episode
        new_data_1011 = collector_1011.collect(train_iter=learner.train_iter, policy_kwargs=collect_kwargs)
        new_data_89 = collector_89.collect(train_iter=learner.train_iter, policy_kwargs=collect_kwargs)
        new_data_56 = collector_56.collect(train_iter=learner.train_iter, policy_kwargs=collect_kwargs)

        new_data = new_data_1011 + new_data_89 + new_data_56
        # 拼到一起
        # Learn policy from collected data
        learner.train(new_data, collector_1011.envstep*3)
        if collector_1011.envstep * 3 >= max_env_step or learner.train_iter >= max_train_iter:
            break
