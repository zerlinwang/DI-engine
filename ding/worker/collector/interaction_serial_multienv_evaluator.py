...
@SERIAL_EVALUATOR_REGISTRY.register('interaction_multi_env')
class InteractionSerialMultiEnvEvaluator(ISerialEvaluator):
    """
    Overview:
    ...
    def eval(
        ...
        with self._timer:
            while not eval_monitor.is_finished():
                ...
                actions = {i: a['action'][:agent_num] for i, a in policy_output.items()}
